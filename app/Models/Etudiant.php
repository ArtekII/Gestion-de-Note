...
class Etudiant extends Model
{
    ...
    protected $validationRules      = [
        ...
        "resultat" => "required|in_list[P,AB,B,Aj]"
    ];
    protected $validationMessages   = [
        ...
        "id_matiere" => [
            ...
            "integer" => "L'identifiant de la matière doit être un entier."
        ],
        "id_semestre" => [
            "required" => "L'identifiant du semestre est requis.",
            "integer" => "L'identifiant du semestre doit être un entier."
        ],
        "id_option" => [
            "required" => "L'identifiant de l'option est requis.",
            "integer" => "L'identifiant de l'option doit être un entier."
        ],
        "note" => [
        ...
        "credit" => [
            ...
            "integer" => "Le crédit doit être un entier.",
            "greater_than" => "Le crédit doit être supérieur à 0."
        ],
        "resultat" => [
            "required" => "Le résultat est requis.",
            "in_list" => "Le résultat doit être l'un des suivants : P, AB, B, Aj."
        ]
    ];
